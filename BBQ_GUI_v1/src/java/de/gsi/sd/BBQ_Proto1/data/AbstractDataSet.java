...
abstract public class AbstractDataSet implements DataSet {
...
*/    
   ...
   */
  public void appendData(int nextSample, float[] data) 
  {
    for (int j=0;j<data.length;j++)
    {
...
//    int x = index * reduction + reduction / 2; /* center of reduction interval */
  ...
  abstract public AbstractDataSet clone(String name);
