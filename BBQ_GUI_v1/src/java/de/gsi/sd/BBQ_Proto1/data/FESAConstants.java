...
public interface FESAConstants {
  ...
  /* Default Values */
  static public final int ACQ_STANDARD_MODE = 1; // 4096 data points taken and FFT performed in the FEC, Default ADC settings, quick display
  static public final int ACQ_FREE_MODE = 0; // All the settings are changeable, the FFT will be done by the Java GUI libraries
}
